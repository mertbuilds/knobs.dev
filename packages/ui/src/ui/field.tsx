...
const FieldSet = ({ className, style, ...props }: React.ComponentProps<'fieldset'>) => (
  <fieldset
    {...stylexProps(styles.set, customClassName(className), style as StyleXStyles)}
    data-slot="field-set"
    {...props}
  />
);
...
const FieldGroup = ({ className, style, ...props }: React.ComponentProps<'div'>) => (
  <div
    {...stylexProps(styles.group, customClassName(className), style as StyleXStyles)}
...
const FieldContent = ({ className, style, ...props }: React.ComponentProps<'div'>) => (
  <div
    {...stylexProps(styles.content, customClassName(className), style as StyleXStyles)}
...
const FieldLabel = ({ className, ...props }: React.ComponentProps<typeof Label>) => (
  <Label
    {...stylexProps(styles.label, customClassName(className))}
...
const FieldTitle = ({ className, style, ...props }: React.ComponentProps<'div'>) => (
  <div
    {...stylexProps(styles.title, customClassName(className), style as StyleXStyles)}
    data-slot="field-label"
    {...props}
  />
);
...
const FieldDescription = ({ className, style, ...props }: React.ComponentProps<'p'>) => (
  <p
    {...stylexProps(styles.description, customClassName(className), style as StyleXStyles)}
...
const FieldSeparator = ({ children, className, style, ...props }: React.ComponentProps<'div'>) => {
  const line = stylexProps(styles.separatorLine);
  const content = stylexProps(styles.separatorContent);
  return (
    <div
      {...stylexProps(styles.separator, customClassName(className), style as StyleXStyles)}
...
const FieldError = ({
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul {...stylexProps(styles.errorList)}>
  ...
  return (
    <div
      {...stylexProps(styles.error, customClassName(className), style as StyleXStyles)}
